...
public class MenuWorld {
    ...
    public MenuWorld(CirclePongGame cpgame, final ActionResolver actionResolver, float gameWidth, float gameHeight) {
        ...
        if(Math.random()< Configuration.AD_FREQUENCY){
            ...
            Tween.to(r1, -1, 0.6f).target(1).repeatYoyo(0, 0).setCallback(cb).setCallbackTriggers(TweenCallback.COMPLETE)
