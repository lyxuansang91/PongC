...
import com.hungle.pongc.screens.Menu;
import com.hungle.pongc.ui.Arrow;
import com.hungle.pongc.ui.MuteButton;
...
public class GameWorld {
    ...
    public GameWorld(CirclePongGame cpgame, ActionResolver actionresolver, float gameWidth, float gameHeight) {
        ...
        this.volumeButton = new MuteButton(20 + this.buttonSize,20+ this.buttonSize, this.buttonSize, this.buttonSize, AssetLoader.soundI, AssetLoader.muteI, Color.WHITE);
        volumeButton.start();
